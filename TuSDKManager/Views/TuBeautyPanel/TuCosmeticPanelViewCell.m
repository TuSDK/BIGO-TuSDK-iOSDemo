/********************************************************
 * @file    : TuCosmeticPanelViewCell.m
...
@interface TuCosmeticPanelViewCell()
{
    UILabel *_titleLabel;
...
@implementation TuCosmeticPanelViewCell
...
- (void)setData:(TuCosmeticHeaderData *)data
{
    ...
    if ([data.cosmeticCode isEqualToString:@"reset"])
    {
        ...
        _titleLabel.text = NSLocalizedStringFromTable(@"tu_cosmeticReset", @"TuSDKConstants", @"美妆");
        _selectPointView.hidden = YES;
    }
    ...
    else
    {
        ...
        _titleLabel.text = NSLocalizedStringFromTable(titleName, @"TuSDKConstants", @"美妆");
...
- (void)setItemData:(TuCosmeticItemData *)itemData
{
    ...
    else
    {
        ...
        {
            _titleLabel.text = NSLocalizedStringFromTable(itemData.stickerName, @"TuSDKConstants", @"美妆");
        }
        ...
        {
            NSArray *eyeLinerArray = [TuBeautyPanelConfig dataSetWithCosmeticCode:itemData.cosmeticCode];
...
- (void)setLipStickData:(TuCosmeticLipStickData *)lipStickData
{
    ...
    {
        //水润
        _titleLabel.text = NSLocalizedStringFromTable(@"tu_水润", @"TuSDKConstants", @"美妆");
        thumbName = @"lipstick_water_ic";
    }
    else if (lipStickData.lipStickType == TuCosmeticLipSticktMoist)
    {
        //滋润
        _titleLabel.text = NSLocalizedStringFromTable(@"tu_滋润", @"TuSDKConstants", @"美妆");
        thumbName = @"lipstick_moist_ic";
    }
    else
    {
        //雾面
        _titleLabel.text = NSLocalizedStringFromTable(@"tu_雾面", @"TuSDKConstants", @"美妆");
...
- (void)setEyeBrowData:(TuCosmeticEyeBrowData *)eyeBrowData
{
    ...
    if (_eyeBrowData.eyeBrowType == TuCosmeticEyeBrowFog)
    {
        ...
        _titleLabel.text = NSLocalizedStringFromTable(@"tu_雾眉", @"TuSDKConstants", @"美妆");
    }
    else
    {
        thumbName = @"eyebrow_root_ic";
        _titleLabel.text = NSLocalizedStringFromTable(@"tu_雾根眉", @"TuSDKConstants", @"美妆");
    }
    _thumbnailView.image = [UIImage imageNamed:thumbName];
}
